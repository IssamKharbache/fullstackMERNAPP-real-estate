      ...
      <div className='flex p-5 max-w-lg mx-auto'>
        ...
        <p className=' text-sm self-center font-semibold '>
            ...
            <span className='text-red-700'>
             ...
             (<span className='text-slate-700'>{`Uploading ${filepercentage}`}</span>) : (filepercentage ===100  ? <span className='text-green-700'>Done uploading image</span>  : " " )}
             </p>
       ...
       <div className="relative flex flex-col gap-4">
        ...
        <button disabled={loading} className='bg-blue-700 text-white rounded-lg p-3 uppercase hover:opacity-90 disabled:opacity-50'>{loading ?<div role="status">
    <svg aria-hidden="true" class="inline w-6 h-6 mr-2 text-gray-900 animate-spin dark:text-gray-900 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
